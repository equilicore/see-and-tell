...
def __indices_mapping(cleaned: Sequence[str],
    ...
    cleaned_indices = sorted(list(set1))
    doc_indices = sorted(list(set2))
...
def extract_noun_phrases(sentences: Sequence[str],
    ...
    # work only with the indices extracted above
    doc_sentences = [doc_sentences[i] for i in doc_indices]
    ...
    return [noun_phrases(s) for s in doc_sentences], cleaned_indices
